...
class MyScrollView extends StatefulWidget {
  static const String routeName = '/mytest/myscrollview';
  @override
          ...
          slivers: <Widget>[
            SliverAppBar(
              ...
              flexibleSpace: FlexibleSpaceBar(
                title: const Text('固定条'),
                background: Stack(
                  fit: StackFit.expand,
                  children: <Widget>[
                    Image.network(
                      'https://ss0.bdstatic.com/70cFuHSh_Q1YnxGkpoWK1HF6hhy/it/u=3791456004,10174324&fm=27&gp=0.jpg',
                      fit: BoxFit.cover,
